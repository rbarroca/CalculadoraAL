      ...
      <div className="border-t border-gray-200 mt-10 pt-10">
        ...
        <div className="relative">
          <input
            ...
            onChange={(e) => setData((prev: any) => ({ ...prev, traditionalRent: e.target.value === '' ? 0 : Number(e.target.value) }))}
            onFocus={handleInputFocus}
        ...
        <div>
          <div className="flex gap-2 mb-6 border-b border-gray-200">
            ...
            <button
              ...
              className={`
                px-6 py-3 font-semibold text-base transition-all flex items-center gap-2
                ${activeTab === 'results'
                  ? 'text-orange-600 border-b-2 border-orange-600'
                  : 'text-gray-600 hover:text-gray-900'
                }
            ...
            >
              ...
              {result && (
                <span className="bg-orange-100 text-orange-600 px-2 py-0.5 rounded-full text-xs font-bold">
                  €{result.netMonthlyProfit.toFixed(0)}/mês
                </span>
              )}
            </button>
          </div>
          ...
          <div className="transition-all duration-300">
            {activeTab === 'input' ? <FormInputs /> : <ResultsSection />}
          </div>
        </div>
      );
    }
